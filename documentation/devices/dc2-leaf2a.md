...
| --------- | --------------- | ------------ | --------- |
| mlag2 | Vlan4094 | 10.255.252.5 | Port-Channel3 |
...
| Ethernet5 | SERVER_dc2-l2leaf2a_Ethernet1 | *access | *10 | *- | *- | 5 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_dc2-spine1_Ethernet1 | - | 192.168.203.5/31 | default | 1500 | False | - | - |
| Ethernet12 | P2P_Core1_Ethernet12 | - | 192.168.98.11/31 | default | 1500 | - | - | - |
| Ethernet13 | P2P_Core2_Ethernet13 | - | 192.168.98.13/31 | default | 1500 | - | - | - |
...
!
interface Ethernet5
   description SERVER_dc2-l2leaf2a_Ethernet1
   no shutdown
...
interface Ethernet12
   ...
   mtu 1500
   ip address 192.168.98.11/31
   isis enable CORE
   isis network point-to-point
!
interface Ethernet13
   description P2P_Core2_Ethernet13
   mtu 1500
   ip address 192.168.98.13/31
   isis enable CORE
   isis network point-to-point
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.168.201.3/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.168.202.3/32 |
| Loopback2 | SR-ISIS Router ID | default | 192.168.99.23/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0000.0023.00 |
| Type | level-2 |
...
router isis CORE
   ...
   segment-routing mpls
      no shutdown
      prefix-segment 192.168.99.23/32 index 23
```
...
| 192.168.203.4 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65299
   ...
   neighbor 10.255.251.5 description dc2-leaf2b_Vlan4093
   ...
   neighbor 192.168.203.4 remote-as 65002
   neighbor 192.168.203.4 description dc2-spine1_Ethernet1
   ...
   vrf VRF_A
      ...
      router-id 192.168.201.3
      neighbor 10.255.251.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.5 description dc2-leaf2b_Vlan3009
