...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_Core2_Ethernet1 | - | 192.168.98.0/31 | default | 1500 | - | - | - |
| Ethernet10 | P2P_dc1-leaf1a_Ethernet10 | - | 192.168.98.2/31 | default | 1500 | - | - | - |
| Ethernet11 | P2P_dc1-leaf1b_Ethernet11 | - | 192.168.98.6/31 | default | 1500 | - | - | - |
| Ethernet12 | P2P_dc2-leaf2a_Ethernet12 | - | 192.168.98.10/31 | default | 1500 | - | - | - |
| Ethernet13 | P2P_dc2-leaf2b_Ethernet13 | - | 192.168.98.14/31 | default | 1500 | - | - | - |
...
!
interface Ethernet1
   description P2P_Core2_Ethernet1
   mtu 1500
   ip address 192.168.98.0/31
   isis enable CORE
   isis network point-to-point
!
interface Ethernet10
   description P2P_dc1-leaf1a_Ethernet10
   mtu 1500
   ip address 192.168.98.2/31
   isis enable CORE
   isis network point-to-point
!
interface Ethernet11
   description P2P_dc1-leaf1b_Ethernet11
   mtu 1500
   ip address 192.168.98.6/31
   isis enable CORE
   isis network point-to-point
!
interface Ethernet12
   description P2P_dc2-leaf2a_Ethernet12
   mtu 1500
   ip address 192.168.98.10/31
   isis enable CORE
   isis network point-to-point
!
interface Ethernet13
   description P2P_dc2-leaf2b_Ethernet13
   mtu 1500
   ip address 192.168.98.14/31
   isis enable CORE
   isis network point-to-point
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | SR-ISIS Router ID | default | 192.168.99.1/32 |
...
router isis CORE
   ...
   segment-routing mpls
      no shutdown
      prefix-segment 192.168.99.1/32 index 1
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.99.2 | 65298 | default | - | Inherited from peer group EVPN-CORE | - | - | - | - | - | - | - |
...
router bgp 65298
   ...
   neighbor 192.168.99.2 peer group EVPN-CORE
