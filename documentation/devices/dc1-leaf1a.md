...
| Ethernet5 | SERVER_dc1-l2leaf1a_Ethernet1 | *access | *10 | *- | *- | 5 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_dc1-spine1_Ethernet1 | - | 192.168.103.1/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_Core1_Ethernet10 | - | 192.168.98.3/31 | default | 1500 | - | - | - |
| Ethernet11 | P2P_Core2_Ethernet11 | - | 192.168.98.5/31 | default | 1500 | - | - | - |
...
!
interface Ethernet5
   description SERVER_dc1-l2leaf1a_Ethernet1
   no shutdown
...
| Port-Channel5 | PortChannel host1 | access | 10 | - | - | - | - | 5 | - |
...
router isis CORE
   ...
   segment-routing mpls
      no shutdown
      prefix-segment 192.168.99.11/32 index 11
```
...
router bgp 65100
   ...
   neighbor 192.168.103.0 description dc1-spine1_Ethernet1
