...
| --------- | --------------- | ------------ | --------- |
| mlag1 | Vlan4094 | 10.255.252.0 | Port-Channel3 |
...
| Ethernet5 | SERVER_dc1-l2leaf1a_Ethernet2 | *access | *10 | *- | *- | 5 |
...
!
interface Ethernet5
   description SERVER_dc1-l2leaf1a_Ethernet2
   no shutdown
...
| Loopback2 | SR-ISIS Router ID | default | 192.168.99.12/32 |
...
router isis CORE
   ...
   segment-routing mpls
      no shutdown
      prefix-segment 192.168.99.12/32 index 12
```
